# REST API Version 21.0 references
...
*   [analytics endpoints](c_rest_api_version210_analytics_intro.html)
    ...
    *   [DELETE /analytics/rule\_groups/\{group\_id\} DEPRECATED](21.0--analytics-rule_groups-group_id-DELETE.html)
...
*   [ariel endpoints](c_rest_api_version210_ariel_intro.html)
    ...
    *   [GET /ariel/saved\_search\_dependent\_tasks/\{task\_id\}/results DEPRECATED](21.0--ariel-saved_search_dependent_tasks-task_id-results-GET.html)
...
*   [backup\_and\_restore endpoints](c_rest_api_version210_backup_and_restore_intro.html)
    ...
    *   [POST /backup\_and\_restore/backups/\{id\} DEPRECATED](21.0--backup_and_restore-backups-id-POST.html)
...
*   [config endpoints](c_rest_api_version210_config_intro.html)
    ...
    *   [GET /config/access/user\_roles DEPRECATED](21.0--config-access-user_roles-GET.html)
    ...
    *   [GET /config/event\_sources/custom\_properties/calculated\_properties/\{calculated\_property\_id\}/dependents DEPRECATED](21.0--config-event_sources-custom_properties-calculated_properties-calculated_property_id-dependents-GET.html)
    ...
    *   [POST /config/event\_sources/custom\_properties/property\_cef\_expressions DEPRECATED](21.0--config-event_sources-custom_properties-property_cef_expressions-POST.html)
    ...
    *   [DELETE /config/event\_sources/custom\_properties/property\_nvp\_expressions/\{expression\_id\} DEPRECATED](21.0--config-event_sources-custom_properties-property_nvp_expressions-expression_id-DELETE.html)
    ...
    *   [GET /config/event\_sources/custom\_properties/regex\_property\_dependent\_tasks/\{task\_id\} DEPRECATED](21.0--config-event_sources-custom_properties-regex_property_dependent_tasks-task_id-GET.html)
    ...
    *   [PATCH /config/event\_sources/log\_source\_management/log\_source\_types/dsm\_parameter\_configuration/dsm\_parameter\_allowed\_values DEPRECATED](21.0--config-event_sources-log_source_management-log_source_types-dsm_parameter_configuration-dsm_parameter_allowed_values-PATCH.html)
    ...
    *   [GET /config/event\_sources/wincollect/wincollect\_agents/\{id\} DEPRECATED](21.0--config-event_sources-wincollect-wincollect_agents-id-GET.html)
    ...
    *   [DELETE /config/flow\_sources/custom\_properties/calculated\_properties/\{calculated\_property\_id\} DEPRECATED](21.0--config-flow_sources-custom_properties-calculated_properties-calculated_property_id-DELETE.html)
    ...
    *   [GET /config/flow\_sources/custom\_properties/regex\_properties/\{regex\_property\_id\}/dependents DEPRECATED](21.0--config-flow_sources-custom_properties-regex_properties-regex_property_id-dependents-GET.html)
    ...
    *   [PUT /config/resource\_restrictions/\{resource\_restriction\_id\} DEPRECATED](21.0--config-resource_restrictions-resource_restriction_id-PUT.html)
...
*   [dynamic\_search endpoints](c_rest_api_version210_dynamic_search_intro.html)
    ...
    *   [DELETE /dynamic\_search/searches/\{handle\} DEPRECATED](21.0--dynamic_search-searches-handle-DELETE.html)
...
*   [gui\_app\_framework endpoints](c_rest_api_version210_gui_app_framework_intro.html)
    ...
    *   [GET /gui\_app\_framework/applications/\{application\_id\} DEPRECATED](21.0--gui_app_framework-applications-application_id-GET.html)
...
*   [qrm endpoints](c_rest_api_version210_qrm_intro.html)
    ...
    *   [POST /qrm/qrm\_saved\_search\_groups/\{group\_id\} DEPRECATED](21.0--qrm-qrm_saved_search_groups-group_id-POST.html)
...
*   [reference\_data endpoints](c_rest_api_version210_reference_data_intro.html)
    ...
    *   [GET /reference\_data/map\_dependent\_tasks/\{task\_id\}/results DEPRECATED](21.0--reference_data-map_dependent_tasks-task_id-results-GET.html)
    ...
    *   [POST /reference\_data/tables/\{name\}/description DEPRECATED](21.0--reference_data-tables-name-description-POST.html)
...
*   [scanner endpoints](c_rest_api_version210_scanner_intro.html)
    ...
    *   [GET /scanner/scanprofiles/\{profileid\}/runs/\{run\_id\} DEPRECATED](21.0--scanner-scanprofiles-profileid-runs-run_id-GET.html)
...
*   [siem endpoints](c_rest_api_version210_siem_intro.html)
    ...
    *   [POST /siem/offenses/\{offense\_id\}/notes DEPRECATED](21.0--siem-offenses-offense_id-notes-POST.html)
...
*   [staged\_config endpoints](c_rest_api_version210_staged_config_intro.html)
    ...
    *   [POST /staged\_config/certificates/end\_certificates/\{id\} DEPRECATED](21.0--staged_config-certificates-end_certificates-id-POST.html)
    *   [GET /staged\_config/certificates/root\_certificates DEPRECATED](21.0--staged_config-certificates-root_certificates-GET.html)
    *   [POST /staged\_config/certificates/root\_certificates DEPRECATED](21.0--staged_config-certificates-root_certificates-POST.html)
    *   [DELETE /staged\_config/certificates/root\_certificates/\{id\} DEPRECATED](21.0--staged_config-certificates-root_certificates-id-DELETE.html)
    *   [GET /staged\_config/certificates/root\_certificates/\{id\} DEPRECATED](21.0--staged_config-certificates-root_certificates-id-GET.html)
    *   [GET /staged\_config/deploy\_status DEPRECATED](21.0--staged_config-deploy_status-GET.html)
    *   [POST /staged\_config/deploy\_status DEPRECATED](21.0--staged_config-deploy_status-POST.html)
    *   [GET /staged\_config/deployment/hosts DEPRECATED](21.0--staged_config-deployment-hosts-GET.html)
    *   [GET /staged\_config/deployment/hosts/\{id\} DEPRECATED](21.0--staged_config-deployment-hosts-id-GET.html)
    *   [GET /staged\_config/deployment/hosts/\{id\}/tunnels DEPRECATED](21.0--staged_config-deployment-hosts-id-tunnels-GET.html)
    *   [POST /staged\_config/deployment/hosts/\{id\}/tunnels/\{name\} DEPRECATED](21.0--staged_config-deployment-hosts-id-tunnels-name-POST.html)
    *   [GET /staged\_config/flow/applications/active\_applications DEPRECATED](21.0--staged_config-flow-applications-active_applications-GET.html)
    *   [POST /staged\_config/flow/applications/active\_applications DEPRECATED](21.0--staged_config-flow-applications-active_applications-POST.html)
    *   [DELETE /staged\_config/flow/applications/active\_applications/\{id\} DEPRECATED](21.0--staged_config-flow-applications-active_applications-id-DELETE.html)
    *   [GET /staged\_config/flow/applications/active\_applications/\{id\} DEPRECATED](21.0--staged_config-flow-applications-active_applications-id-GET.html)
    *   [POST /staged\_config/flow/applications/active\_applications/\{id\} DEPRECATED](21.0--staged_config-flow-applications-active_applications-id-POST.html)
    *   [GET /staged\_config/remote\_networks DEPRECATED](21.0--staged_config-remote_networks-GET.html)
    *   [POST /staged\_config/remote\_networks DEPRECATED](21.0--staged_config-remote_networks-POST.html)
    *   [DELETE /staged\_config/remote\_networks/\{network\_id\} DEPRECATED](21.0--staged_config-remote_networks-network_id-DELETE.html)
    *   [GET /staged\_config/remote\_networks/\{network\_id\} DEPRECATED](21.0--staged_config-remote_networks-network_id-GET.html)
    *   [POST /staged\_config/remote\_networks/\{network\_id\} DEPRECATED](21.0--staged_config-remote_networks-network_id-POST.html)
    *   [GET /staged\_config/remote\_services DEPRECATED](21.0--staged_config-remote_services-GET.html)
    *   [POST /staged\_config/remote\_services DEPRECATED](21.0--staged_config-remote_services-POST.html)
    *   [DELETE /staged\_config/remote\_services/\{service\_id\} DEPRECATED](21.0--staged_config-remote_services-service_id-DELETE.html)
    *   [GET /staged\_config/remote\_services/\{service\_id\} DEPRECATED](21.0--staged_config-remote_services-service_id-GET.html)
    *   [POST /staged\_config/remote\_services/\{service\_id\} DEPRECATED](21.0--staged_config-remote_services-service_id-POST.html)
    *   [DELETE /staged\_config/yara\_rules DEPRECATED](21.0--staged_config-yara_rules-DELETE.html)
    *   [PUT /staged\_config/yara\_rules DEPRECATED](21.0--staged_config-yara_rules-PUT.html)
*   [system endpoints](c_rest_api_version210_system_intro.html)
    *   [GET /system/about DEPRECATED](21.0--system-about-GET.html)
    *   [GET /system/authorization/password\_policies DEPRECATED](21.0--system-authorization-password_policies-GET.html)
    *   [GET /system/authorization/password\_policies/\{id\} DEPRECATED](21.0--system-authorization-password_policies-id-GET.html)
    *   [POST /system/authorization/password\_policies/\{id\} DEPRECATED](21.0--system-authorization-password_policies-id-POST.html)
    *   [POST /system/authorization/password\_validators DEPRECATED](21.0--system-authorization-password_validators-POST.html)
    *   [GET /system/authorization/settings DEPRECATED](21.0--system-authorization-settings-GET.html)
    *   [POST /system/authorization/settings DEPRECATED](21.0--system-authorization-settings-POST.html)
    *   [GET /system/email\_servers DEPRECATED](21.0--system-email_servers-GET.html)
    *   [POST /system/email\_servers DEPRECATED](21.0--system-email_servers-POST.html)
    *   [DELETE /system/email\_servers/\{email\_server\_id\} DEPRECATED](21.0--system-email_servers-email_server_id-DELETE.html)
    *   [GET /system/email\_servers/\{email\_server\_id\} DEPRECATED](21.0--system-email_servers-email_server_id-GET.html)
    *   [POST /system/email\_servers/\{email\_server\_id\} DEPRECATED](21.0--system-email_servers-email_server_id-POST.html)
    *   [GET /system/eula\_acceptances DEPRECATED](21.0--system-eula_acceptances-GET.html)
    *   [GET /system/eula\_acceptances/\{id\} DEPRECATED](21.0--system-eula_acceptances-id-GET.html)
    *   [POST /system/eula\_acceptances/\{id\} DEPRECATED](21.0--system-eula_acceptances-id-POST.html)
    *   [GET /system/eulas DEPRECATED](21.0--system-eulas-GET.html)
    *   [GET /system/information/encodings DEPRECATED](21.0--system-information-encodings-GET.html)
    *   [GET /system/information/locales DEPRECATED](21.0--system-information-locales-GET.html)
    *   [POST /system/server\_connection\_validator DEPRECATED](21.0--system-server_connection_validator-POST.html)
    *   [GET /system/servers DEPRECATED](21.0--system-servers-GET.html)
    *   [GET /system/servers/\{server\_id\} DEPRECATED](21.0--system-servers-server_id-GET.html)
    *   [POST /system/servers/\{server\_id\} DEPRECATED](21.0--system-servers-server_id-POST.html)
    *   [GET /system/servers/\{server\_id\}/firewall\_rules DEPRECATED](21.0--system-servers-server_id-firewall_rules-GET.html)
    *   [PUT /system/servers/\{server\_id\}/firewall\_rules DEPRECATED](21.0--system-servers-server_id-firewall_rules-PUT.html)
    *   [GET /system/servers/\{server\_id\}/network\_interfaces/bonded DEPRECATED](21.0--system-servers-server_id-network_interfaces-bonded-GET.html)
    *   [POST /system/servers/\{server\_id\}/network\_interfaces/bonded DEPRECATED](21.0--system-servers-server_id-network_interfaces-bonded-POST.html)
    *   [DELETE /system/servers/\{server\_id\}/network\_interfaces/bonded/\{device\_name\} DEPRECATED](21.0--system-servers-server_id-network_interfaces-bonded-device_name-DELETE.html)
    *   [POST /system/servers/\{server\_id\}/network\_interfaces/bonded/\{device\_name\} DEPRECATED](21.0--system-servers-server_id-network_interfaces-bonded-device_name-POST.html)
    *   [GET /system/servers/\{server\_id\}/network\_interfaces/ethernet DEPRECATED](21.0--system-servers-server_id-network_interfaces-ethernet-GET.html)
    *   [POST /system/servers/\{server\_id\}/network\_interfaces/ethernet/\{device\_name\} DEPRECATED](21.0--system-servers-server_id-network_interfaces-ethernet-device_name-POST.html)
    *   [GET /system/servers/\{server\_id\}/system\_time\_settings DEPRECATED](21.0--system-servers-server_id-system_time_settings-GET.html)
    *   [POST /system/servers/\{server\_id\}/system\_time\_settings DEPRECATED](21.0--system-servers-server_id-system_time_settings-POST.html)
    *   [GET /system/servers/\{server\_id\}/timezones DEPRECATED](21.0--system-servers-server_id-timezones-GET.html)
